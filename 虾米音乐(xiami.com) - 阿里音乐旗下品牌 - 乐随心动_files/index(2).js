(function($) {
    ...
    $(function(){
        ...
        Listen.prototype = {
            _listenHeadTpl : '<h2>'
                            + '<div class="chuanyue">'
                                +'<a href="javascript:void 0:;" id="chuanyueBtn" data-spm-click="gostr=/xiamipc;locaid=d1;" class="btn" title="我要穿越">我要穿越</a>'
                            +'</div>'
            ...
            _renderContent: function(data) {
                ...
                var listenWrapTpl =   '<div id="listenWrap"><div class="item-cover" id="itemCover">'
                    ...
                    +'<div class="item-util">'
                        +'<div class="collect">'
                            +'<a href="javascript:void 0:;" onclick="tag('+ song.song_id +',3);return false" id="collectBtn" class="btn" data-spm-click="gostr=/xiamipc;locaid=d2;">收藏</a>'
                        +'</div>'
                        +'<div class="share">'
                            +'<a href="javascript:void 0:;" onclick="recommend('+ song.song_id +',32);return false;" id="shareBtn" class="btn" data-spm-click="gostr=/xiamipc;locaid=d3;">分享</a>'
                        +'</div>'
                    +'</div>'
                    +'<div class="item-song">'
                        +'<h2>'
